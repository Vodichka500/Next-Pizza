...
const checkoutSummary = ({cart, SERVICE_FEE, DELIVERY_COST}) => {
    return (
        <div className="col-span-2 mt-9">
            <div className="w-full py-4 border-2 rounded-2xl min-h-[200px] mt-6">
                ...
                <div className="px-5 mt-5">
                    <Button type="submit" variant="primary" className="w-full bg-primary text-white text-base py-6" disabled={!cart.cartRedux.totalAmount || cart.cartRedux.totalAmount === 0}>Перейти к
                        оплате</Button>
                </div>
            </div>
        </div>
